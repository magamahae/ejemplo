...
def UsersRecommend( año : int):
    ...
    # Obtener el top 3 de juegos más recomendados y sus valores según rank
    top3_games = top3_by_year[top3_by_year['rank'] <= 3]

    # Formatear el resultado como lista de diccionarios
    result = [{"Puesto {}: {}".format(rank, title)} for rank, title in zip(top3_games['rank'], top3_games['title'])]
...
def recomendacion_juego( id de producto ): 
    ...
    # retorno: lista con 5 juegos recomendados similares al ingresado
...
def recomendacion_usuario( id de usuario ):
    ...
    # retorno ista con 5 juegos recomendados para dicho usuario